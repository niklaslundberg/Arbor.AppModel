...
namespace Arbor.App.Extensions.DependencyInjection
{
    ...
    {
        public ExtendedServiceDescriptor(Type serviceType,
            Type implementationType,
            ServiceLifetime lifetime,
            Type? moduleType) : base(serviceType, implementationType, lifetime) => ModuleType = moduleType;
        ...
        public ExtendedServiceDescriptor(Type serviceType,
            ...
            ServiceLifetime lifetime,
            Type? moduleType) : base(serviceType, factory, lifetime) => ModuleType = moduleType;
